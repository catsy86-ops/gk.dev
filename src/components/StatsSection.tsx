...
import { Calendar, Rocket, Code2, Users, Gauge } from "lucide-react";
...
const StatsSection = () => {
  ...
  const stats = [
    { icon: <Calendar className="h-6 w-6" strokeWidth={1.8} />, value: 7, suffix: "+", label: t.stats.experienceLabel, sublabel: t.stats.experienceSub },
    { icon: <Rocket className="h-6 w-6" strokeWidth={1.8} />, value: 25, suffix: "+", label: t.stats.projectsLabel, sublabel: t.stats.projectsSub },
    { icon: <Code2 className="h-6 w-6" strokeWidth={1.8} />, value: 12, suffix: "+", label: t.stats.techLabel, sublabel: t.stats.techSub },
    { icon: <Users className="h-6 w-6" strokeWidth={1.8} />, value: 15, suffix: "+", label: t.stats.clientsLabel, sublabel: t.stats.clientsSub },
  ];
