  ...
  ({ id, label, children, className = "", divider = true }, ref) => (
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden" aria-hidden="true">
        <div className="absolute top-0 -left-40 w-[500px] h-[500px] rounded-full bg-primary/[0.04] dark:bg-primary/[0.02] blur-[120px] hidden md:block" />
        <div className="absolute bottom-0 -right-40 w-[400px] h-[400px] rounded-full bg-accent-blue/[0.04] dark:bg-accent-blue/[0.02] blur-[100px] hidden md:block" />
      </div>
